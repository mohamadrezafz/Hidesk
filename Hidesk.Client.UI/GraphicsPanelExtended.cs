...
//{
// public   class GraphicsPanelExtended : GraphicsPanel
//    {
...
//			switch (Size)
//			{
//				case StatusBarPanelAutoSize.Normal:
...
//			if (BackgroundImage == null) return coordinates;
//			//	Make sure our control width and height are not 0 and our image width and height are not 0
//			if (Width == 0 || Height == 0 || BackgroundImage.Width == 0 || BackgroundImage.Height == 0) return coordinates;
...
//				float ratioWidth = (float)BackgroundImage.Width / Width;
//				newX *= ratioWidth;
//				float scale = (float)Width / BackgroundImage.Width;
//				float displayHeight = scale * BackgroundImage.Height;
...
//				float ratioHeight = (float)BackgroundImage.Height / Height;
//				newY *= ratioHeight;
//				float scale = (float)Height / BackgroundImage.Height;
//				float displayWidth = scale * BackgroundImage.Width;
...
//			int diffWidth = Width - BackgroundImage.Width;
//			int diffHeight = Height - BackgroundImage.Height;
...
//					if (p.X >= 0 && p.X < BackgroundImage.Width && p.Y >= 0 && p.Y < BackgroundImage.Height)
//					{
